...
public class ProjectAutoUtil2 {
	...
	private static	String tablename = "rumo_comment";
	private static	String model = beanModel.toLowerCase();
	private static String author = "中华墨风";
	private static String description = "文章评论";
	...
	public static List<Map<String,String>> loadTable() {
		try {
			...
			Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/rumoblog?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull", "root","mkxiaoer");
